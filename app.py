...
app = Flask(__name__)
LOT = 65
state = {"ist":"", "ltp":0, "c1_3":"Waiting 9:15", "c2_3":"Waiting 9:18", "call3":"Ready Tomorrow", "put3":"Ready Tomorrow", "status":"READY", "msg":"Starting"}
...
def get_ltp():
    ...
    try:
        r=requests.get("https://query1.finance.yahoo.com/v8/finance/chart/%5ENSEI?interval=1m", headers={"User-Agent":"Mozilla/5.0"}, timeout=8)
