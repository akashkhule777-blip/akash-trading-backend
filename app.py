...
def home():
    ...
    return f"BOT LIVE | 3Min: {count_3min}/{MAX_3MIN} | 5Min: {count_5min}/{MAX_5MIN} | Total {total}/20 | Logic: Option Chart 50% Retest + EMA20 Var"
...
@app.route('/reset')
def reset():
    global count_3min, count_5min, armed_3min, armed_5min
    count_3min = 0
    count_5min = 0
    armed_3min = None
    armed_5min = None
